...
st.markdown(
    """
    The Reforestation Calculator tool allows a user to define a region of interest (ROI) on a map and then plots the NLCD 2021 layer for the ROI.
    
    The app then calculates the individual landcover types for the region and more speciifcally the areas of non-forested land coverage under a user-defined slope threshold.

    Click on "reforestation calculator" tab in the left panel to get started.
    """
)

st.header("Step 1: Gather a GeoJSON")
st.write("Copy to your clipboard a GeoJSON by clicking on the link at the top of the page.")
